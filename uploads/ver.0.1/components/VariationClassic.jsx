      ...
      {currentPage !== 'shorts' && (
        <div ref={contentRef} style={{ flex: 1 }}>
          {currentPage === 'shop' && (
            shopProduct ? (
              <AtomyProductDetail
                product={shopProduct.id === '000017' ? HEMOHIM_DETAIL : shopProduct}
                isMobile={true}
              ...
              >
                ...
                {isActive && (
                  <span style={{
                    ...
                    background: '#00B6F0', borderRadius: 2,
                  }} />
                )}
              </button>
            );
