  ...
  return (
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
        ...
        {/* 장바구니 — 카운트 배지 */}
        <button aria-label="장바구니 2건" style={{
          background: 'transparent', border: 'none', cursor: 'pointer',
          padding: 8, lineHeight: 0, position: 'relative', borderRadius: 999,
          transition: 'background 0.15s',
        }}
...
function ShopOverlay({ isMobile, onClose }) {
  ...
  return (
    <div style={{
      ...
      <div className="phone-scroll" style={{
        ...
        {selectedProduct ? (
          <AtomyProductDetail
            product={selectedProduct.id === '000017' ? HEMOHIM_DETAIL : selectedProduct}
            isMobile={isMobile}
